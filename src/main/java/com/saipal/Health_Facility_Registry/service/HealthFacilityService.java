...
//			
	...
	public List<HealthFacility> getHfbyMunicipality(int pageNo, int pagesize, String sortby, String token,
			String municipality) {
		if (pagesize >= 100) {
			pagesize = 100;
		}
	...
	public List<HealthFacility> getHfSearch(int pageNo, int pagesize, String token, String sortby,
	...
	public List<HealthFacility> getFacilityList(String search, String roles, String rvalues, Integer uid,
		...
		if ("provincial".equals(roles)) {
			...
			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByProvince(search, rvalues, uid,
					pageable);
...
//			return healthFacilityRepo.findAllHFListByPalika(search, rvalues,uid);
		...
		if ("district".equals(roles)) {
			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByDistrict(search, rvalues, uid,
					pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
			} else {
...
//		return healthFacilityRepo.findAllList(search);
	...
	public List<HealthFacility> getFacilityListBed(String search, String roles, String rvalues, Integer uid,
			Integer pageNo, Integer pagesize) {
		Pageable pageable = PageRequest.of(pageNo, pagesize, Sort.by("id"));
		if ("provincial".equals(roles)) {

			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByProvinceBed(search, rvalues, uid,
					pageable);
//			return healthFacilityRepo.findAllHFListByProvince(search, rvalues,uid,pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
		...
		if ("palika".equals(roles)) {
			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByPalikaBed(search, rvalues, uid,
					pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
			} else {
...
//			return healthFacilityRepo.findAllHFListByPalika(search, rvalues,uid);
		...
		if ("district".equals(roles)) {
			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByDistrictBed(search, rvalues, uid,
					pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
			} else {
...
//		return healthFacilityRepo.findAllList(search);
	...
	public List<HealthFacility> getFacilityListOnline(String search, String roles, String rvalues, Integer uid,
			Integer pageNo, Integer pagesize) {
		Pageable pageable = PageRequest.of(pageNo, pagesize, Sort.by("id"));
		if ("provincial".equals(roles)) {

			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByProvinceOnline(search, rvalues, uid,
					pageable);
//			return healthFacilityRepo.findAllHFListByProvince(search, rvalues,uid,pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
		...
		if ("palika".equals(roles)) {
			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByPalikaOnline(search, rvalues, uid,
					pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
			} else {
...
//			return healthFacilityRepo.findAllHFListByPalika(search, rvalues,uid);
		...
		if ("district".equals(roles)) {
			Page<HealthFacility> pagedResult = healthFacilityRepo.findAllHFListByDistrictOnline(search, rvalues, uid,
					pageable);
			if (pagedResult.hasContent()) {
				return pagedResult.getContent();
			} else {
