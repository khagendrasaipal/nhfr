...
public interface HealthFacilityRepo extends PagingAndSortingRepository<HealthFacility, Integer> {
	...
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  LEFT JOIN admin_local_level_structure mu ON p.municipality=mu.vcid WHERE p.soft_delete=0 and ( p.hf_name LIKE concat('%',?1,'%') OR p.hf_code LIKE concat('%',?1,'%') OR mu.nameen LIKE concat('%',?1,'%')) ",nativeQuery=true)
	...
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id WHERE p.soft_delete=0 and ( p.hf_name LIKE concat('%',?1,'%') OR p.hf_code LIKE concat('%',?1,'%')) and (p.opstatus  in('Functional','') or p.opstatus is null) ",nativeQuery=true)
...
//	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.hf_name LIKE concat('%',?1,'%') p.?2=?3 ",nativeQuery=true)
//	List<HealthFacility> findAllHFList(String search,String roles, String rvalues);

	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%') ) AND p.province=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.province=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",nativeQuery=true)
	Page<HealthFacility> findAllHFListByProvince(String search, String rvalues,Integer uid, Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.level in(37,40,41,43,44,45,46,48,49,50,65,66) and (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%') ) AND p.province=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.province=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",nativeQuery=true)
	Page<HealthFacility> findAllHFListByProvinceBed(String search, String rvalues,Integer uid, Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.submitto=2 and (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%') ) AND p.province=?2 ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.submitto=2 and p.hf_name LIKE concat('%',?1,'%') AND p.province=?2",nativeQuery=true)
	...
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.municipality=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3) ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.municipality=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3) ",nativeQuery=true)
	Page<HealthFacility> findAllHFListByPalika(String search, String rvalues,Integer uid,Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.level in(37,40,41,43,44,45,46,48,49,50,65,66) and p.hf_name LIKE concat('%',?1,'%') AND p.municipality=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3) ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.municipality=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3) ",nativeQuery=true)
	Page<HealthFacility> findAllHFListByPalikaBed(String search, String rvalues,Integer uid,Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.id=?2  ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.id=?2  ",nativeQuery=true)
	Page<HealthFacility> findAllHFListByHF(String search, String rvalues,Integer uid,Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.submitto=4 and p.hf_name LIKE concat('%',?1,'%') AND p.municipality=?2  ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.submitto=4 and p.hf_name LIKE concat('%',?1,'%') AND p.municipality=?2  ",nativeQuery=true)
	...
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.district=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",countQuery="SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.district=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",nativeQuery=true)
	Page<HealthFacility> findAllHFListByDistrict(String search, String rvalues,Integer uid,Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.level in (37,40,41,43,44,45,46,48,49,50,65,66) and p.hf_name LIKE concat('%',?1,'%') AND p.district=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",countQuery="SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.hf_name LIKE concat('%',?1,'%') AND p.district=?2 and p.id NOT IN(select hfid from user_hf_access where userid=?3)",nativeQuery=true)
	Page<HealthFacility> findAllHFListByDistrictBed(String search, String rvalues,Integer uid,Pageable pageable);
	
	@Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.submitto=3 and p.hf_name LIKE concat('%',?1,'%') AND p.district=?2 ",countQuery="SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.submitto=3 and p.hf_name LIKE concat('%',?1,'%') AND p.district=?2 ",nativeQuery=true)
	...
	@Query(value="select * FROM hfregistry WHERE  hf_name LIKE concat('%',?1,'%') OR hf_code LIKE concat('%',?1,'%')",countQuery = "SELECT count(*) FROM hfregistry WHERE hf_name LIKE concat('%',?1,'%') OR hf_code LIKE concat('%',?1,'%')",nativeQuery=true)
...
//	@Query(value="select * From users",nativeQuery=true)
	@Query(value="select * FROM Users WHERE  username LIKE concat('%',?1,'%') OR firstname LIKE concat('%',?1,'%')",countQuery = "SELECT count(*) FROM Users WHERE username LIKE concat('%',?1,'%') OR firstname LIKE concat('%',?1,'%')",nativeQuery=true)
...
//			 List<ApiExchange> getLatestsss(int lastid);
		...
		List<HealthFacility> getFacilityByPalikaServiceradio(String palika, int service, String tab, String col);
		   ...
		   @Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%')) ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and  (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%')) ",nativeQuery=true)
		Page<HealthFacility> findAllHFList(String search, Pageable pageable);
		   
		   @Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0 and p.level in(37,40,41,43,44,45,46,48,49,50,65,66) and (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%')) ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=0  and p.level in(37,40,41,43,44,45,46,48,49,50,65,66) and  (p.hf_name LIKE concat('%',?1,'%') or p.hf_code LIKE concat('%',?1,'%')) ",nativeQuery=true)
			Page<HealthFacility> findAllHFListBed(String search, Pageable pageable);
		   
		   @Query(value="SELECT p.* FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.hf_name LIKE concat('%',?1,'%') ",countQuery = "SELECT count(*) FROM hfregistry p LEFT JOIN health_facility_type n ON p.type = n.id LEFT JOIN ownership o ON p.ownership=o.id  LEFT JOIN facility_level l ON p.level=l.id LEFT JOIN facility_level fl ON p.oldlevel=fl.id  WHERE p.soft_delete=1 and p.onlinestatus=1 and p.hf_name LIKE concat('%',?1,'%') ",nativeQuery=true)
		...
		Page<Object[]> findHfByPalika(String municipality, Pageable pageable);
		 ...
		 @Query(value = 
				   ...
				   + " DATE_FORMAT(hf.created_at, '%Y-%m-%d') AS created_at,DATE_FORMAT(hf.created_at, '%Y-%m-%d') AS updated_at, hf.latitude, hf.longitude, hf.hmis_code AS iid, hf.source AS agency, hf.hf_code AS hfCode,hf.type, "
		            ...
		            + "JOIN admin_local_level_structure ON admin_local_level_structure.vcid = hf.municipality "
		            + "LEFT JOIN health_facility_type ON health_facility_type.id = hf.type "
		            + "WHERE hf.soft_delete = 0 and  hf.hf_name LIKE concat('%',?1,'%') OR hf_code LIKE concat('%',?1,'%')"
		   			,
		   				countQuery = "SELECT count(*) FROM hfregistry where soft_delete=0 and hf_name LIKE concat('%',?1,'%') OR hf_code LIKE concat('%',?1,'%')", nativeQuery = true)
...
//	@Query("FROM HealthFacility WHERE hf_name LIKE concat('%',?1,'%') OR hf_code LIKE concat('%',?1,'%')")
//	List<HealthFacility> findAllList(String search);
//	@Query(value = "SELECT * FROM tbllanguagefile WHERE english like concat('%',?1,'%') and nepali like %?2%",
//		    countQuery = "SELECT count(*) FROM tbllanguagefile WHERE english like concat('%',?1,'%') and nepali like %?2%",
//		    nativeQuery = true)
